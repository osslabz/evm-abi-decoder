...
**Acknowledgement**:
This project is based on [abidecoder](https://github.com/prettymuchbryce/abidecoder), which itself is a port
of  [abi-decoder](https://github.com/ConsenSys/abi-decoder).
