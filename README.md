...
![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/osslabz/evm-abi-decoder/release.yml?branch=dev&label=perform-release&logo=semanticrelease)
